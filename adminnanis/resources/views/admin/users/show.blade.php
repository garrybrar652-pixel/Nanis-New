...
<head>
    ...
    <title>Unified Inbox - User Details</title>
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <img src="{{ asset('adminlte/dist/img/user2-160x160.jpg') }}"
                                                alt="User Avatar" class="img-fluid img-circle">
                                        </div>
                                        <div class="col-md-9">
                                            <dl class="row">
                                                ...
                                                <dd class="col-sm-9">{{ $user->created_at->format('M d, Y H:i') }}
                                                </dd>

                                                <dt class="col-sm-3">Last Updated:</dt>
                                                <dd class="col-sm-9">{{ $user->updated_at->format('M d, Y H:i') }}
                                                </dd>
                                ...
                                <div class="card-footer">
                                    <a href="{{ route('admin.users.index') }}" class="btn btn-secondary">Back to
                                        Users</a>
