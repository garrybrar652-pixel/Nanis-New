...
<head>
    ...
    <title>Unified Inbox - Edit User</title>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('role') is-invalid @enderror"
                                                ...
                                                <option value="user"
                                                    {{ old('role', $user->hasRole('user') ? 'user' : '') == 'user' ? 'selected' : '' }}>
                                                    User</option>
                                                <option value="admin"
                                                    {{ old('role', $user->hasRole('admin') ? 'admin' : '') == 'admin' ? 'selected' : '' }}>
                                                    Admin</option>
                                            </select>
                                            @error('role')
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="is_verified">User Verified</label>
                                            </div>
                                        </div>
                                        <div class="form-group">
