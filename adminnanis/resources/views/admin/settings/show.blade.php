...
<head>
    ...
    <title>Nanis - Setting Details</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Setting Details</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                                    ...
                                    <dl class="row">
                                        ...
                                        <dd class="col-sm-9">
                                            @if ($setting->type === 'boolean')
                                                <span
                                                    class="badge {{ $setting->value ? 'badge-success' : 'badge-danger' }} badge-lg">
                                                    {{ $setting->value ? 'True' : 'False' }}
                                                </span>
                                            @elseif($setting->type === 'json')
                                                <pre><code>{{ json_encode(json_decode($setting->value), JSON_PRETTY_PRINT) }}</code></pre>
                                            @else
                                        ...
                                        <dd class="col-sm-9">
                                            <span class="badge badge-secondary">{{ ucfirst($setting->group) }}</span>
                                        </dd>

                                        <dt class="col-sm-3">Description:</dt>
                                        <dd class="col-sm-9">{{ $setting->description ?? 'No description provided' }}
                                        </dd>

                                        <dt class="col-sm-3">Public Access:</dt>
                                        <dd class="col-sm-9">
                                        ...
                                        <dd class="col-sm-9">{{ $setting->created_at->format('M d, Y H:i') }}</dd>

                                        <dt class="col-sm-3">Last Updated:</dt>
                                        <dd class="col-sm-9">{{ $setting->updated_at->format('M d, Y H:i') }}</dd>
                                    </dl>
                                </div>
                                <!-- /.card-body -->
                                <div class="card-footer">
                                    <a href="{{ route('admin.settings.index') }}" class="btn btn-secondary">Back to
                                        Settings</a>
